        ...
        with mp.tasks.vision.GestureRecognizer.create_from_options(options) as recognizer:
            ...
            while True:
                ...
                if not headless:
                    ...
                    # Mirror only the preview; training and inference see identical orientation.
                    preview = cv2.flip(frame, 1)
                    cv2.putText(preview, f"{label or '-'} {score:.2f} | q quits", (10, 25),
                                cv2.FONT_HERSHEY_SIMPLEX, .55, (0, 255, 0), 1)
                    cv2.putText(preview, last_action, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, .45, (0, 255, 0), 1)
